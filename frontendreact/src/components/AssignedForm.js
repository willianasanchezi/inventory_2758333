...
const AssignedForm = () => {
  ...
  const { idProducto: selectedIdProducto, idUsuario: selectedidUsuario } =
    location.state || {};
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      try {
        ...
        alert(
          "Asignación creada, pero hubo un error al actualizar el estado del producto"
        );
      }
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="form-group">
            ...
            <input
              type="datetime-local"
              className="form-control"
              name="asigFechaDevolucionProgramada"
